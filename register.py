...
username_entry = ctk.CTkEntry(register_frame,placeholder_text="start typing...", font=("Arial", 14), width=300)
...
email_entry = ctk.CTkEntry(register_frame,placeholder_text="start typing...", font=("Arial", 14), width=300)
...
password_entry = ctk.CTkEntry(register_frame,placeholder_text="start typing...", show="*", font=("Arial", 14), width=300)
...
confirm_password_entry = ctk.CTkEntry(register_frame, placeholder_text="start typing...", show="*", font=("Arial", 14),
                                      width=300)
...
def connect_user():
    subprocess.Popen([sys.executable, "connect.py"])
    root.destroy()
...
connection_button = ctk.CTkButton(register_frame, fg_color="transparent", text="Already have an account?", text_color=text_color,
                                  font=("Arial", 12), command=connect_user)
connection_button.grid(row=8, column=0, columnspan=2)
